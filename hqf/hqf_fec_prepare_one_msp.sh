...
while read line; do 
    ...
    paste ${fec_folder}/${TD_window}/U2_U1_stride${stride_fec} ${fec_folder}/${TD_window}/U2_U2_stride${stride_fec} | awk '{print $2 - $1}' > ${fec_folder}/${TD_window}/U2_U1-U2_U2_stride${stride_fec}
    paste ${fec_folder}/${TD_window}/U1_U2_stride${stride_fec} ${fec_folder}/${TD_window}/U1_U1_stride${stride_fec} | awk '{print $2 - $1}' > ${fec_folder}/${TD_window}/U1_U2-U1_U1_stride${stride_fec}
    paste ${fec_folder}/${TD_window}/U2_U2_stride${stride_fec} ${fec_folder}/${TD_window}/U2_U1_stride${stride_fec} | awk '{print $2 - $1}' > ${fec_folder}/${TD_window}/U2_U2-U2_U1_stride${stride_fec}
    paste ${fec_folder}/${TD_window}/U1_U1_stride${stride_fec} ${fec_folder}/${TD_window}/U1_U1_stride${stride_fec} | awk '{print $2 - $1}' > ${fec_folder}/${TD_window}/U1_U1-U1_U2_stride${stride_fec}
