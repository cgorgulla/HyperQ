...
opt_max_steps="$(grep -m 1 "^opt_max_steps_${subsystem}="  ../../../${HQ_CONFIGFILE_MSP} | tr -d '[[:space:]]' | awk -F '[=#]' '{print $2}')"
opt_trajectory_stride="$(grep -m 1 "^opt_trajectory_stride_${subsystem}="  ../../../${HQ_CONFIGFILE_MSP} | tr -d '[[:space:]]' | awk -F '[=#]' '{print $2}')"
opt_restart_stride="$(grep -m 1 "^opt_restart_stride_${subsystem}="  ../../../${HQ_CONFIGFILE_MSP} | tr -d '[[:space:]]' | awk -F '[=#]' '{print $2}')"
    ...
    if [[ "${opt_continue^^}" == "TRUE" ]]; then
        if [ -d "${tdsname}/cp2k" ]; then
            ...
            if [[ -s cp2k/cp2k.out.restart.bak-1 ]]; then
                ...
                # Printing information
                echo -e "\n * The preparation of the optimization folder for the TDS with index ${tds_index} in the folder ${tdsname} has been successfully completed.\n\n"
    ...
    if [[ "${opt_programs}" == *"cp2k"* ]]; then
        ...
        if [ "${lambda}" == "0.000" ]; then
            ...
            if [ -f ../../../input-files/cp2k/${inputfolder_cp2k_opt_specific}/main.opt.sys1 ]; then
                cp ../../../input-files/cp2k/${inputfolder_cp2k_opt_specific}/main.opt.sys1 ${tdsname}/cp2k/cp2k.in.main
            elif [ -f ../../../input-files/cp2k/${inputfolder_cp2k_opt_general}/main.opt.sys1 ]; then
                cp ../../../input-files/cp2k/${inputfolder_cp2k_opt_general}/main.opt.sys1 ${tdsname}/cp2k/cp2k.in.main
            else
            ...
            if [ -f ../../../input-files/cp2k/${inputfolder_cp2k_opt_specific}/main.opt.sys2 ]; then
                cp ../../../input-files/cp2k/${inputfolder_cp2k_opt_specific}/main.opt.sys2 ${tdsname}/cp2k/cp2k.in.main
            elif [ -f ../../../input-files/cp2k/${inputfolder_cp2k_opt_general}/main.opt.sys2 ]; then
                cp ../../../input-files/cp2k/${inputfolder_cp2k_opt_general}/main.opt.sys2 ${tdsname}/cp2k/cp2k.in.main
            else
            ...
            if [ -f ../../../input-files/cp2k/${inputfolder_cp2k_opt_specific}/main.opt.lambda ]; then
                cp ../../../input-files/cp2k/${inputfolder_cp2k_opt_specific}/main.opt.lambda ${tdsname}/cp2k/cp2k.in.main
            elif [ -f ../../../input-files/cp2k/${inputfolder_cp2k_opt_general}/main.opt.lambda ]; then
                cp ../../../input-files/cp2k/${inputfolder_cp2k_opt_general}/main.opt.lambda ${tdsname}/cp2k/cp2k.in.main
            else
        ...
        sed -i "s|opt_max_steps_placeholder|${opt_max_steps}|g" ${tdsname}/cp2k/cp2k.in.*
        sed -i "s|opt_trajectory_stride_placeholder|${opt_trajectory_stride}|g" ${tdsname}/cp2k/cp2k.in.*
        sed -i "s|opt_restart_stride_placeholder|${opt_restart_stride}|g" ${tdsname}/cp2k/cp2k.in.*
    fi
