...
if [ "${tdcycle_si_activate^^}" == "TRUE" ]; then
    hqh_fes_prepare_tds_si_dummies.py system1 system1.cp2k.psf system1.prm ${tdw_count} decreasing
    hqh_fes_prepare_tds_si_dummies.py system2 system2.cp2k.psf system2.prm ${tdw_count} increasing
fi
